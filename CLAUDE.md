...
This is **No Proof Left Behind** - a Claude Code Skill that transforms terse physics textbook content into comprehensive, research-level tutorials with complete proofs, detailed derivations, and professional LaTeX formatting.
...
3. **Expands** the content with complete mathematical proofs and explanations (using the Claude Code Skill)
...
### Add New Macros
Edit `.claude/skills/physics-text-to-tutorial/physics-macros.tex`
